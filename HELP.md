...
* The original package name 'com.blastza.spring-oauth-client' is invalid and this project uses 'com.blastza.spring_oauth_client' instead.
...
```
$ docker run --rm spring-oauth-client:0.0.1-SNAPSHOT
```
